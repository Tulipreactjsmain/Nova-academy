...
import { ZigZagVector, Button } from "@/app/components";
...
export default function CoursesList({
  slice,
  includeAllCoursesHeading = false,
  ...
  includeAllCoursesHeading?: boolean;
        ...
        <div className={styles.grid}>
          ...
          {status === "succeeded" &&
            (slice !== undefined || slice !== null
              ...
              <div
                key={course._id}
                className={`${styles.product} flex flex-col h-full cursor-pointer`}
              ...
              >
                ...
                <div className="flex justify-between items-center p-4 border-t">
                  ...
                  <Button onClick={() => handleViewMembers(course)}>
                    View Members
                  </Button>
                </div>
              </div>
